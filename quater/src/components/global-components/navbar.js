	...
	render() {
		...
		return (
			<div>
											...
											<ul>
												...
												<li>
													...
													<div className="header-top-btn">
														<a type="button" href="#ltn__utilize-login" className="theme-btn-1 btn btn-block ltn__utilize-toggle" >Login</a>
									...
									<div className="ltn__drop-menu user-menu">
										<ul>
											<li>
												...
												<ul className="go-top">
													<li><Link to="#ltn__utilize-login">Sign in</Link></li>
													<a type="button" href="#ltn__utilize-login" className="ltn__utilize-toggle" >Sing in</a>
													<li><Link to="/register">Register</Link></li>
													<li><Link to="/my-account">My Account</Link></li>
												</ul>
											</li>
				...
				{/* LOGIN MODAL START*/}
				<div id="ltn__utilize-login" className="ltn__utilize ltn__utilize-cart-menu">

					<div className="ltn__utilize-menu-head">
						<span className="ltn__utilize-menu-title">Inicisar Sesión</span>
						<button className="ltn__utilize-close">×</button>
					</div>
					<div className="account-login-inner">
						<form method="GET" className="ltn__form-box contact-form-box">
							...
							<div className="btn-wrapper mt-0">
								<div className="header-top-btn">
									<a type="button" href="#ltn__utilize-login" className="theme-btn-1 btn btn-block ltn__utilize-toggle" >Inicisar Sesión</a>

								</div>

							</div>
							<div className="go-to-btn mt-20">
								<a href="#" title="Ólvidaste tu Contraseña?" data-bs-toggle="modal" data-bs-target="#ltn_forget_password_modal"><small>Ólvidaste tu Contraseña?</small></a>
							</div>
							<div className="go-to-btn mt-20">
					...
					<div className="" style={{float: "right"}}>
						<a  type="button" className="btn btn-block theme-btn-closed ltn__utilize-close">Cerrar</a >
					</div>
